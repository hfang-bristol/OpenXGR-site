package My_openxgr::Controller::Action;
use My_openxgr::Controller::Utils;
...
sub EAdomain {
	...
	my $ajax_manhattan_pdf_file='';
  	...
  	if(defined($domainlist)){
		my $tmpFolder = $My_openxgr::Controller::Utils::tmpFolder; # public/tmp
		...
		if($line_counts >=2){
			My_openxgr::Controller::Utils::export_to_file($input_filename, $my_input);
		}
...
# for calling R function
My_openxgr::Controller::Utils::export_to_file($rscript_filename, $my_rscript);
