...
rmarkdown::render("now.RMD_EAregion.Rmd", bookdown::html_document2(number_sections=F,theme=c("readable","united")[2], hightlight="default"), output_dir="/Users/hfang/Sites/XGR/OpenXGR-site/app/examples")
...
```{r}
#hlink_pdf <- oAuxEmbed("~Sites/XGR/OpenXGR-site/app/examples/EAregion_enrichment_dotplot.pdf", link.text="Download PDF")
...
library(png)
library(grid)
#filename <- str_c('~Sites/XGR/OpenXGR-site/app/examples/EAregion_enrichment_dotplot.png')
...
```{r}
#hlink_pdf <- oAuxEmbed("~Sites/XGR/OpenXGR-site/app/examples/EAregion_enrichment_forestplot.pdf", link.text="Download PDF")
...
library(png)
library(grid)
#filename <- str_c('"~Sites/XGR/OpenXGR-site/app/examples/EAregion_enrichment_forestplot.png')
