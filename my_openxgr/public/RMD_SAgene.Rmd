...
rmarkdown::render("now.RMD_SAgene.Rmd", bookdown::html_document2(number_sections=F,theme=c("readable","united")[2], hightlight="default"), output_dir="/Users/hfang/Sites/XGR/OpenXGR-site/app/examples")
...
```{r}
#input.file <- "~/Sites/XGR/OpenXGR-site/my_xgrplus/public/app/examples/eg_SAgene.txt"
...
library(png)
library(grid)
#filename <- str_c('~Sites/XGR/OpenXGR-site/app/examples/SAgene_crosstalk.png')
